    ...
    return (
        <div className="ret-homepage">
            <div className="ret-sidebar">
                <div className="ret-profile-section text-center">
                    <div className="ret-profile-img">{userInitials}</div>
                    <h5 className="ret-user-name">{username.toUpperCase()}</h5>
                </div>
                <ul className="ret-nav flex-column">
                    {[
                    ...
                    <li className="ret-nav-item-logout" onClick={handleLogout}>
            ...
            <div className="ret-main-content">
                ...
                {activeSection === "viewInsertedDetails" && (
                    <div className="ret-details-container">
                        <div className="ret-product-cards">
                            {insertedDetails.length > 0 ? (
                                insertedDetails.map((detail, index) => (
                                    <div key={index} className="ret-product-card">
                                        {detail.imageUrl && (
                                            <img
                                                src={detail.imageUrl}
                                                alt="Product"
                                                className="ret-product-image" width="100" height="100"
                                            />
                                        )}
                ...
                {activeSection === "getProductJourney" && (
                    <div className="ret-journey-container">
                        <div className="journey-box">
                            ...
                            <div className="ret-enter-prod-ID">
                            ...
                            <button className="ret-btn-primary" onClick={handleGetProductJourney} disabled={!formData.productId.trim()}>
                                <i className="fa-solid fa-route"></i> Fetch Journey
                            </button>

                            {productJourney ? (
                                <div className="ret-journey-timeline">
                                    <h4>Your Product Journey</h4>
                                    <ul className="ret-timeline">
                                        <li>
                                            <div className="ret-timeline-content">
                                ...
                                <p className="ret-no-journey">No journey details available.</p>
                            )}
                        </div>
                    </div>
                )}
